...
- **Git Add** : `git add` 명령어를 통해 변경사항을 Staging Area에 추가합니다. `git add [filename]`으로 특정 파일을 추가할 수 있습니다. `git add .`으로 모든 변경사항을 추가할 수 있습니다
...
- **Git Commit** : `git commit` 명령어를 통해 Local Repo에 변경사항이 저장됩니다. `git commit -m "commit message`
- **Git Push** : `git push` 명령어를 통해 Local Repo의 변경사항을 Remote Repo로 업로드 합니다 `git push origin [branch_name]`
